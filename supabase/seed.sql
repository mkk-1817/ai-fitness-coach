...
-- Reference equipment and exercise demo media.
-- Workout and nutrition plans are generated by the AI; no food catalogue is seeded.
-- ==============================================================================
...
-- 2. Exercise media reference (verified demo videos attached to matching AI-prescribed exercises)
